            ...
            <div className="w-full max-w-sm">
                ...
                focus:border-transparent transition-all text-base"
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3.5 bg-gradient-to-r from-violet-600 to-indigo-600 text-zinc-900 dark:text-white
              font-semibold rounded-xl transition-all hover:from-violet-500 hover:to-indigo-500
