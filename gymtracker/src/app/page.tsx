    ...
    <main className="min-h-dvh text-white">
      <section className="mx-auto flex min-h-dvh w-full max-w-7xl flex-col px-6 pb-16 pt-8 sm:px-10 lg:px-12">
        <header className="app-panel flex items-center justify-between gap-4 px-5 py-4 sm:px-6">
          <div>
            <p className="app-kicker text-violet-200">{t('eyebrow')}</p>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-full border border-white/12 px-4 py-2 text-sm font-medium text-zinc-100 transition hover:border-violet-400/60 hover:bg-white/8"
            >
              {t('whatsappCta')}
            </a>
            <Link
              href="/login"
              className="rounded-full bg-gradient-to-r from-violet-500 to-indigo-500 px-4 py-2 text-sm font-semibold text-white shadow-[0_12px_30px_rgba(109,40,217,0.35)] transition hover:from-violet-400 hover:to-indigo-400"
            >
              {t('signIn')}
            </Link>
          </div>
